...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", default="results/vision", help="Output directory")
    ...
    parser.add_argument("--sam-checkpoint", default="sam2_t.pt", help="SAM 2 checkpoint path")
    parser.add_argument("--sam-device", default="cuda:1", help="Device for SAM 2 (e.g. cuda:1, cpu)")
    parser.add_argument("--wood-checkpoint", default="weights/wood_seg.pt",
